...
SECRET_KEY = 'django-insecure-wjisp)2hw$!o&6&s!52#z-b+tmlf6a+@^m$x-aljr!7aa-dl-z'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'config.resources.custom_resources',
                'config.context_processors.choices_processor',
            ],
        },
    },
]
...
if 'PYTHONANYWHERE_DOMAIN' in os.environ or 'isanchez.pythonanywhere.com' in os.environ.get('HOSTNAME', ''):
